...
/*
    ...
    // http://localhost:8080/bank/createAccount?accountNr=EE123&balance=100
    ...
    // http://localhost:8080/bank/accountbalance/EE123
    @GetMapping("bank/accountbalance/{accountNumber}")
